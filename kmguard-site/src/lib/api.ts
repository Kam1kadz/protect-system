...
export const adminApi = {
    ...
    setLicExpiry: (id: string, expiresAt: string) =>
        api.patch(`/api/v1/admin/licenses/${id}/expires`, { expires_at: expiresAt }),
    ...
    updatePlan: (id: string, data: { display_name?: string; is_active?: boolean; sort_order?: number; product_type?: string; config_file_key?: string | null }) =>
