...
func (s *LoaderService) Authenticate(
	...
	expected := computeLoaderHMAC(*lic.SecretKey, challenge+"|"+hwid)
	...
	sessionKey := hex.EncodeToString(crypto.DeriveKey(s.cfg.MasterKey, "sk:"+tokenHash))
...
func computeLoaderHMAC(secretKey, data string) string {
